 ...
 */
public class ProductCategoryDao extends BaseDaoImpl<ProductCategory, String> {

    Dao<ProductCategory, String> productCategoryDao;

    public ProductCategoryDao(ConnectionSource connectionSource) throws SQLException {
